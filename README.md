...
- Зона. Реле в таком случае работает в режиме **входа**. К его передней стороне подключается источник редстоуна, для сработки этой зоны достаточно подать активировать редстоун на реле.
